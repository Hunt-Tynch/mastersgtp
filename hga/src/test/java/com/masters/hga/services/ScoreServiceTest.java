...
public class ScoreServiceTest {
        ...
        void testCreateScore() {
                ...
                ScoreDTO scoreDTO = new ScoreDTO(600, JudgeMapper.INSTANCE.toDto(judge1), 1,
                                DogMapper.INSTANCE.toDTO(dog1), DogMapper.INSTANCE.toDTO(dog2),
                                DogMapper.INSTANCE.toDTO(dog3),
                ...
                // () -> assertEquals(30,
                // dogRepository.findById(dog2.getNumber()).get().getSdscore()),
                // () -> assertEquals(25,
                // dogRepository.findById(dog3.getNumber()).get().getSdscore()),
                // () -> assertEquals(20,
                // dogRepository.findById(dog4.getNumber()).get().getSdscore()),
                // () -> assertEquals(15,
                // dogRepository.findById(dog5.getNumber()).get().getSdscore()));

                ScoreDTO scoreDTO2 = new ScoreDTO(600, JudgeMapper.INSTANCE.toDto(judge2), 1,
                                DogMapper.INSTANCE.toDTO(dog5), DogMapper.INSTANCE.toDTO(dog2),
                                DogMapper.INSTANCE.toDTO(dog1),
                ...
                // () -> assertEquals(60,
                // dogRepository.findById(dog1.getNumber()).get().getSdscore()),
                // () -> assertEquals(60,
                // dogRepository.findById(dog2.getNumber()).get().getSdscore()),
                // () -> assertEquals(45,
                // dogRepository.findById(dog3.getNumber()).get().getSdscore()),
        ...
        void testDeleteScore() {
                ...
                ScoreDTO scoreDTO = new ScoreDTO(600, JudgeMapper.INSTANCE.toDto(judge1), 0,
                                DogMapper.INSTANCE.toDTO(dog1), DogMapper.INSTANCE.toDTO(dog2),
                                DogMapper.INSTANCE.toDTO(dog3),
                                DogMapper.INSTANCE.toDTO(dog4), DogMapper.INSTANCE.toDTO(dog5));
